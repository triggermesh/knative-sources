...
COMMANDS           = knative-sources-controller slacksource-adapter zendesksource-adapter webhooksource-adapter httppollersource-adapter
...
.PHONY: help mod-download build install release test coverage lint fmt fmt-test images cloudbuild-test cloudbuild clean install-gotestsum install-golangci-lint
