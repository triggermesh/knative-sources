...
import (
	...
	externalversions "github.com/triggermesh/knative-sources/http/pkg/client/generated/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/knative-sources/http/pkg/client/generated/informers/externalversions.SharedInformerFactory from context.")
	}
