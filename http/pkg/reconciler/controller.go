...
import (
	...
	httpsourceinformer "github.com/triggermesh/knative-sources/http/pkg/client/generated/injection/informers/sources/v1alpha1/httpsource"
	"github.com/triggermesh/knative-sources/http/pkg/client/generated/injection/reconciler/sources/v1alpha1/httpsource"
...
func NewController(
	...
	httpSourceInformer := httpsourceinformer.Get(ctx)
	...
	ksvcInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: controller.FilterControllerGK(v1alpha1.Kind("HttpSource")),
