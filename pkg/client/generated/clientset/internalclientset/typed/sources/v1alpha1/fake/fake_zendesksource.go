...
var zendesksourcesResource = schema.GroupVersionResource{Group: "sources.triggermesh.io", Version: "v1alpha1", Resource: "zendesksources"}
...
func (c *FakeZendeskSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ZendeskSource, err error) {
	...
	return obj.(*v1alpha1.ZendeskSource), err
}
...
func (c *FakeZendeskSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ZendeskSourceList, err error) {
	...
	list := &v1alpha1.ZendeskSourceList{ListMeta: obj.(*v1alpha1.ZendeskSourceList).ListMeta}
	for _, item := range obj.(*v1alpha1.ZendeskSourceList).Items {
