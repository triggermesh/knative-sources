...
func (c *ociMetricsSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.OciMetricsSource, err error) {
	result = &v1alpha1.OciMetricsSource{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ociMetricsSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.OciMetricsSourceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.OciMetricsSourceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ocimetricssources").
...
func (c *ociMetricsSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *ociMetricsSources) Create(ctx context.Context, ociMetricsSource *v1alpha1.OciMetricsSource, opts v1.CreateOptions) (result *v1alpha1.OciMetricsSource, err error) {
	result = &v1alpha1.OciMetricsSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ocimetricssources").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ociMetricsSource).
		Do(ctx).
		Into(result)
	return
}
...
func (c *ociMetricsSources) Update(ctx context.Context, ociMetricsSource *v1alpha1.OciMetricsSource, opts v1.UpdateOptions) (result *v1alpha1.OciMetricsSource, err error) {
	result = &v1alpha1.OciMetricsSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ocimetricssources").
		Name(ociMetricsSource.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(ociMetricsSource).
		Do(ctx).
		Into(result)
...
func (c *ociMetricsSources) UpdateStatus(ctx context.Context, ociMetricsSource *v1alpha1.OciMetricsSource, opts v1.UpdateOptions) (result *v1alpha1.OciMetricsSource, err error) {
	result = &v1alpha1.OciMetricsSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ocimetricssources").
...
func (c *ociMetricsSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *ociMetricsSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *ociMetricsSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.OciMetricsSource, err error) {
	result = &v1alpha1.OciMetricsSource{}
