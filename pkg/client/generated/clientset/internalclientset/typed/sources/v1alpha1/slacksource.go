...
func (c *slackSources) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SlackSource, err error) {
...
func (c *slackSources) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SlackSourceList, err error) {
...
func (c *slackSources) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *slackSources) Create(ctx context.Context, slackSource *v1alpha1.SlackSource, opts v1.CreateOptions) (result *v1alpha1.SlackSource, err error) {
	result = &v1alpha1.SlackSource{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("slacksources").
...
func (c *slackSources) Update(ctx context.Context, slackSource *v1alpha1.SlackSource, opts v1.UpdateOptions) (result *v1alpha1.SlackSource, err error) {
	result = &v1alpha1.SlackSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slacksources").
...
func (c *slackSources) UpdateStatus(ctx context.Context, slackSource *v1alpha1.SlackSource, opts v1.UpdateOptions) (result *v1alpha1.SlackSource, err error) {
	result = &v1alpha1.SlackSource{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("slacksources").
...
func (c *slackSources) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *slackSources) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *slackSources) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SlackSource, err error) {
	result = &v1alpha1.SlackSource{}
