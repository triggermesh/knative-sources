...
import (
	...
	foosource "github.com/triggermesh/knative-sources/pkg/client/generated/injection/reconciler/sources/v1alpha1/foosource"
...
// reason FooSourceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "FooSourceReconciled", "FooSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for FooSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ foosource.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ foosource.Finalizer = (*Reconciler)(nil)
...
//var _ foosource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ foosource.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.FooSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.FooSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.FooSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.FooSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
