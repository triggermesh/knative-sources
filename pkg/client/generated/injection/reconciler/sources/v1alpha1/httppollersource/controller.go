...
import (
	...
	httppollersource "github.com/triggermesh/knative-sources/pkg/client/generated/injection/informers/sources/v1alpha1/httppollersource"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "httppollersource-controller"
	defaultFinalizerName       = "httppollersources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	httppollersourceInformer := httppollersource.Get(ctx)

	lister := httppollersourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.HTTPPollerSource"),
	)
