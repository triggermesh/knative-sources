...
type doReconcile func(ctx context.Context, o *v1alpha1.HTTPSource) reconciler.Event
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.HTTPSources(s.namespace)
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, existing *v1alpha1.HTTPSource, desired *v1alpha1.HTTPSource) error {
