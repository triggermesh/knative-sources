...
import (
	...
	ocimetricssource "github.com/triggermesh/knative-sources/pkg/client/generated/injection/informers/sources/v1alpha1/ocimetricssource"
...
const (
	defaultControllerAgentName = "ocimetricssource-controller"
	defaultFinalizerName       = "ocimetricssources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	ocimetricssourceInformer := ocimetricssource.Get(ctx)

	lister := ocimetricssourceInformer.Lister()
