...
const (
	defaultControllerAgentName = "webhooksource-controller"
	defaultFinalizerName       = "webhooksources.sources.triggermesh.io"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	webhooksourceInformer := webhooksource.Get(ctx)

	lister := webhooksourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.triggermesh.io.WebhookSource"),
	)
