...
import (
	...
	v1alpha1 "github.com/triggermesh/knative-slack-source/pkg/apis/sources/v1alpha1"
	versioned "github.com/triggermesh/knative-slack-source/pkg/client/clientset/versioned"
	sourcesv1alpha1 "github.com/triggermesh/knative-slack-source/pkg/client/listers/sources/v1alpha1"
	zap "go.uber.org/zap"
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister sourcesv1alpha1.SlackSourceLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
