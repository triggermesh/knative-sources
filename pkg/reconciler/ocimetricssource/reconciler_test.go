...
import (
	...
	reconcilerv1alpha1 "github.com/triggermesh/knative-sources/pkg/client/generated/injection/reconciler/sources/v1alpha1/ocimetricssource"
...
func newEventSource() *v1alpha1.OciMetricsSource {
	...
	src := &v1alpha1.OciMetricsSource{
		Spec: v1alpha1.OciMetricsSourceSpec{
			...
			OracleApiPrivateKey: v1alpha1.SecretValueFromSource{
			...
			OracleApiPrivateKeyPassphrase: v1alpha1.SecretValueFromSource{
				SecretKeyRef: &corev1.SecretKeySelector{
					LocalObjectReference: corev1.LocalObjectReference{
			...
			OracleApiPrivateKeyFingerprint: v1alpha1.SecretValueFromSource{
				SecretKeyRef: &corev1.SecretKeySelector{
					LocalObjectReference: corev1.LocalObjectReference{
