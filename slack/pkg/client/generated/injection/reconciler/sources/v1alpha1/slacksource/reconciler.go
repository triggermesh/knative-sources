...
import (
	...
	sourcesv1alpha1 "github.com/triggermesh/knative-sources/slack/pkg/client/generated/listers/sources/v1alpha1"
	zap "go.uber.org/zap"
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.SlackSources(namespace)
...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.SlackSource, desired *v1alpha1.SlackSource) error {
