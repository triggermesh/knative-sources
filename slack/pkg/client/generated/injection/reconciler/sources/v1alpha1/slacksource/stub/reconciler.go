...
import (
	...
	slacksource "github.com/triggermesh/knative-sources/slack/pkg/client/generated/injection/reconciler/sources/v1alpha1/slacksource"
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "SlackSourceReconciled", "SlackSource reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for SlackSource resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ slacksource.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ slacksource.Finalizer = (*Reconciler)(nil)
...
//var _ slacksource.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ slacksource.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.SlackSource) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.SlackSource) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.SlackSource) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.SlackSource) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
