...
import (
	...
	externalversions "github.com/triggermesh/knative-sources/slack/pkg/client/informers/externalversions"
	client "github.com/triggermesh/knative-sources/slack/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/knative-sources/slack/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
