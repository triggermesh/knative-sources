...
import (
	...
	versionedscheme "github.com/triggermesh/knative-sources/slack/pkg/client/clientset/versioned/scheme"
	injectionclient "github.com/triggermesh/knative-sources/slack/pkg/client/injection/client"
	slacksource "github.com/triggermesh/knative-sources/slack/pkg/client/injection/informers/sources/v1alpha1/slacksource"
...
const (
	defaultControllerAgentName = "slacksource-controller"
	defaultFinalizerName       = "slacksources.sources.knative.dev"
	defaultQueueName           = "slacksources"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	slacksourceInformer := slacksource.Get(ctx)
	...
	rec := &reconcilerImpl{
		...
		Lister:     slacksourceInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
