...
import (
	...
	externalversions "github.com/triggermesh/knative-sources/zendesk/pkg/client/generated/informers/externalversions"
	client "github.com/triggermesh/knative-sources/zendesk/pkg/client/generated/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/triggermesh/knative-sources/zendesk/pkg/client/generated/informers/externalversions.SharedInformerFactory from context.")
	}
