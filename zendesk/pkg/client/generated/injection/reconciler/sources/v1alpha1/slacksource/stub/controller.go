...
import (
	...
	v1alpha1zendesksource "github.com/triggermesh/knative-sources/zendesk/pkg/client/generated/injection/reconciler/sources/v1alpha1/zendesksource"
...
// NewController creates a Reconciler for ZendeskSource and returns the result of NewImpl.
func NewController(
	ctx context.Context,
	...
	r := &Reconciler{}
	impl := v1alpha1zendesksource.NewImpl(ctx, r)
