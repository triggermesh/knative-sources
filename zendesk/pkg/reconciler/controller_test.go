...
import (
	...
	_ "github.com/triggermesh/knative-sources/zendesk/pkg/client/generated/injection/informers/sources/v1alpha1/zendesksource/fake"
...
const (
	ImageEnv = "ZENDESKSOURCE_ADAPTER_IMAGE"
	ImageVal = "triggermesh.registry/zendesk-adapter:v0.0.0"
)
